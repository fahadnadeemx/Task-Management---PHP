...
<div class="sidebar">
    ...
    <ul>
        ...
        <li><a href="<?= MYHTTP ?? '../' ?>/admin/viewDepartment.html"><i><img src="<?= MYHTTP ?? '../' ?>/assets/images/icons/14.png" width="25px"></i>View Department</a>
        </li>
        <hr>
        <h5>User</h5>
        <li><a href="<?= MYHTTP ?? '../' ?>dashboard/user/add/"><i><img src="<?= MYHTTP ?? '../' ?>/assets/images/icons/15.png" width="25px"></i>Add User</a></li>
        <li><a href="<?= MYHTTP ?? '../' ?>dashboard/user/"><i><img src="<?= MYHTTP ?? '../' ?>/assets/images/icons/16.png" width="25px"></i>View User</a></li>
    </ul>
</div>
<!--sidebar end-->